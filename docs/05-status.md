...
**M9′ 9.1 关口稿**：[spec/22-agent.md](../spec/22-agent.md) 已起草 AGENT-01–10，逐条带验收，待评审。
两类锚点方案已批准用于起草；预算默认值在本规范评审通过后对实现生效。9.0 文档与测量已复核通过，
B/C 宿主实测仍缺证据；M8′ 门 2 / 门 4 待裁定不变。本轮没有实现 Agent API，9.2 未开始。
