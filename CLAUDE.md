...
`spec/12-m0-m1-plan.md`、`spec/13-m2-plan.md`、`spec/14-m3-plan.md`、`spec/15-m4-plan.md`、`spec/16-m5-plan.md`、`spec/18-m7-plan.md` 是里程碑任务分解（# / 任务 / 规范 / DoD；M6 的 `spec/17-m6-plan.md` 在 `m6-embedded` 分支上）。M7 计划于 2026-09-06 写成、尚未开工，开工前按 M6 并入后的 `main` 重测基线。
